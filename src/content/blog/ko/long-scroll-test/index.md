...
tags:
  ...
  - testing
summary: >
  모바일에서 스마트 고정 헤더가 스크롤 방향에 따라 숨고 다시 드러나는 동작을 실제로 확인하기
  위한 긴 본문 테스트 글입니다. 본문의 의미보다는 스크롤 반응, 읽기 리듬, 섹션 간 간격이
  자연스러운지 관찰하는 데 목적이 있고, 이번엔 신설된 요약 블록이 헤더와 본문 사이에서 어떻게
  읽히는지도 함께 확인합니다.
draft: true
---
