...
하지만 **토큰**은 다릅니다. eosjs가 특정 토큰이 올라가있는 컨트랙트의 계정 이름을 알 수도 없고, 그 컨트랙트 내부에 전송기능이 trasfer가 아닌 다른 액션 이름을 가질 수도 있기 때문입니다. 따라서 이와 같은 경우엔 eosjs의 transaction 메서드를 사용할 수 있습니다.
