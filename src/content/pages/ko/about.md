...
identity:
  ...
  summary: "백엔드 아키텍처와 분산 시스템을 설계해 온 엔지니어입니다. 핀테크 스타트업에서 8년 동안 다양한 블록체인 지갑 서비스, 분산 시스템, TSS 기반 MPC 서명 시스템을 만들면서 느끼고 배운 것을 이 블로그에 정리합니다."
  photo:
    src: "/avatar.jpg"
    alt: "Sam (김상호) 프로필 사진"
  socials:
    - type: github
      href: "https://github.com/rlaace423"
      label: "GitHub"
    - type: email
      href: "mailto:rlaace423@gmail.com"
      label: "Email"
    - type: linkedin
      href: "https://www.linkedin.com/in/sangho-kim-30041515a"
      label: "LinkedIn"
    - type: instagram
  ...
  experience:
    - company: "(주)헥토 월렛원 (구 헥슬란트)"
      ...
      description: "Node.js/TypeScript 기반 멀티체인 지갑 API 플랫폼 'Octet'의 초기 아키텍처 설계부터 일 500만 건 트랜잭션 규모의 분산 시스템 구축까지 백엔드 전반을 맡아 왔습니다. TSS 기반 MPC 서명 시스템과 사내 운영 인프라를 함께 설계했고, ISMS, VASP(가상자산사업자) 라이선스 취득을 주도했습니다."
    - company: "현대오토에버"
      role: "연구원 · 선행기술센터 IoT기술팀"
      start: "2016"
      end: "2017"
